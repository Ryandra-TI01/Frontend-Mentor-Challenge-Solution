import desktop_img from './assets/image-hero-desktop.png'
import mobile_img from './assets/image-hero-mobile.png'
...
function ListNavMenu(props) {
  return(<li className="nav-option-list">       
      <a href="#" className="dropdown-item">{props.svg ?props.svg:''}{props.text}</a>
  </li>)
}
function NavItem(props) {
  return (<li>
  <a className="nav-link nav-item" aria-current="page" href="#"data-aos="fade-down" data-aos-duration="1100">{props.text}</a>
</li>)}

function ExitButton() {  
  return(
    <li className="nav-wrapper-exit">
      <img className='nav-button-exit' src={iconClose} alt="ExitButton" />
    </li>
  )
}
...
function App() {
  return (
    <>
	<nav className="navbar navbar-expand-lg mt-2 nav">
		<div className="container-fluid ps-4">
			<img alt="logo" className="navbar-brand title-img nav-img" data-aos="fade-right" data-aos-duration="500" src={logo} width="70px" />
			...
			<div className="collapse navbar-collapse list-wrapping" id="navbarSupportedContent">
            ...
            <ExitButton/>
            <a aria-expanded="false" className="nav-link nav-item nav-item-option" data-aos="fade-down" data-aos-duration="700" data-bs-toggle="dropdown" href="#" id="nav-dropdown1" role="button">
              Features
              <svg className="ms-1" height="6" id="arrow-down" width="10" xmlns="http://www.w3.org/2000/svg">
                <path d="m1 1 4 4 4-4" fill="none" stroke="#686868" strokeWidth="1.5" />
              </svg>
            </a>
            <ul className="dropdown-menu nav-option-menu">
              <ListNavMenu text='Todo List' svg={<svg className="me-2" width="14" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M14 3v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h1V1a1 1 0 1 1 2 0v1h2V1a1 1 0 1 1 2 0v1h2V1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 1 1Zm-2 3H2v1h10V6Zm0 3H2v1h10V9Zm0 3H2v1h10v-1Z" fill="#726CEE"/></svg>}/>
              <ListNavMenu text='Calender' svg={<svg className="me-2" width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M12.667 8.667h-4v4h4v-4ZM11.334 0v1.333H4.667V0h-2v1.333h-1C.75 1.333 0 2.083 0 3v11.333C0 15.25.75 16 1.667 16h12.667C15.25 16 16 15.25 16 14.333V3c0-.917-.75-1.667-1.666-1.667h-1V0h-2Zm3 14.333H1.667V5.5h12.667v8.833Z" fill="#4BB1DA"/></svg>}/>
              <ListNavMenu text='Reminder' svg={<svg className="me-2" width="13" height="17" xmlns="http://www.w3.org/2000/svg"><path d="M6.408 13.916c-3.313 0-6-1.343-6-3 0-.612.371-1.18 1-1.654V7.916a5 5 0 0 1 3.041-4.6 2 2 0 0 1 3.507-1.664 2 2 0 0 1 .411 1.664 5.002 5.002 0 0 1 3.041 4.6v1.346c.629.474 1 1.042 1 1.654 0 1.657-2.687 3-6 3Zm0 1c.694 0 1.352-.066 1.984-.16.004.054.016.105.016.16a2 2 0 0 1-4 0c0-.055.012-.106.016-.16.633.094 1.29.16 1.984.16Z" fill="#EDD556"/></svg>}/>
              <ListNavMenu text='Planning' svg={<svg className="me-2" width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0Zm0 2.133a5.867 5.867 0 1 0 0 11.734A5.867 5.867 0 0 0 8 2.133ZM8 3.2a4.8 4.8 0 1 1 0 9.6 4.8 4.8 0 0 1 0-9.6Zm-.533 2.667a.533.533 0 0 0-.534.533v2.133c0 .295.24.534.534.534h3.2a.533.533 0 0 0 0-1.067H8V6.4a.533.533 0 0 0-.533-.533Z" fill="#8E4CB6"/></svg>}/>
            </ul>
					<li className="nav-item dropdown">
						<a aria-expanded="false" className="nav-link nav-item nav-item-option" data-aos="fade-down" data-aos-duration="900" data-bs-toggle="dropdown" href="#" role="button">
							Company
							<svg className="ms-1" height="6" id="arrow-down" width="10" xmlns="http://www.w3.org/2000/svg">
								<path d="m1 1 4 4 4-4" fill="none" stroke="#686868" strokeWidth="1.5" />
							</svg>
						...
						<ul className="dropdown-menu nav-option-menu">
              <ListNavMenu text='History'/>
              <ListNavMenu text='Our Team'/>
              <ListNavMenu text='Blog'/>
						</ul>
					</li>
					<NavItem text='carrers'/>
          <NavItem text='About'/>
				</ul>
				<a aria-current="page" className="nav-link nav-item nav-button-login d-flex" data-aos="fade-down" data-aos-duration="800" href="#">
					Login
				</a>
				<button className="nav-button-register nav-item" data-aos="fade-down" data-aos-duration="1000">
					Register
				</button>
			</div>
		</div>
	...
	<section className="main container">
		<div className="main-column-1">
			<h1 className="main-title " data-aos="fade-up" data-aos-duration="900">
				Make{' '}
				<br className="br" />
				remote work
			</h1>
			<p className="main-desc mt-3" data-aos="fade-up" data-aos-duration="1100">
				{' '}Get your team in sync, no matter your location. Streamline processes, create team rituals, and watch productivity soar.
			</p>
			<button className="main-button-learnMore mt-3" data-aos="fade-up" data-aos-duration="1500">
				Learn more
			</button>
      <Copyright svg1={<svg data-aos="zoom-in-up" data-aos-duration="1000" height="20" viewBox="0 0 114 20" width="114" xmlns="http://www.w3.org/2000/svg">
					<path
						...
						fill="#ADADAD"
					/>
				</svg>} svg2={<svg data-aos="zoom-in-up" data-aos-duration="1300" height="36" viewBox="0 0 73 36" width="73" xmlns="http://www.w3.org/2000/svg">
					<path
						...
						fill="#ADADAD"
					/>
				</svg>} svg3={<svg data-aos="zoom-in-up" data-aos-duration="1700" height="20" viewBox="0 0 90 20" width="90" xmlns="http://www.w3.org/2000/svg">
					<path
						...
						fillRule="evenodd"
					/>
				</svg>} svg4={<svg data-aos="zoom-in-up" data-aos-duration="2000" height="24" viewBox="0 0 83 24" width="83" xmlns="http://www.w3.org/2000/svg">
					<path
		...
		<div className="main-column-2 text-end">
			<picture>
				<source media="(max-width: 376px)" srcSet={mobile_img} />
				<img className="main-image" data-aos="zoom-in" data-aos-duration="1000" src={desktop_img} width="60%" />
			</picture>
		</div>
	</section>
	<div id="nav-bg-collapse"/>
    </>
  )
}
